...
<SelectPrimitive.Trigger
  ...
  class={cn(
    ...
    "dark:hover:bg-input/50 focus-visible:border-ring focus-visible:ring-ring/50",
    "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40",
    "aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 flex",
    "w-fit items-center justify-between gap-1.5 rounded-lg border bg-transparent",
